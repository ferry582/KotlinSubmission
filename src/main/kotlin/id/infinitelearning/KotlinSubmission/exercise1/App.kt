...
fun myProfile() {
    // Variables
    val firstName: String = "Ferry"
    val lastName: String = "Dwianta"
    val age: Int = 20
...
fun myName(): String {
    ...
    val groupMember = listOf<String>("Ferry", "Alex", "Andre", "Zidan", "Anjas")
...
fun main() {
     ...
     *
     */
    groupDetail(6, listOf("Ferry", "Alex", "Andre", "Zidan", "Anjas"), "Morning")
